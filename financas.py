...
# A senha real é: Filpes.3
senha_codificada = "RmlscGVzLjM="  # base64 de 'Filpes.3'

def autenticar_senha(senha_digitada):
    senha_real = base64.b64decode(senha_codificada).decode("utf-8")
    return senha_digitada == senha_real
...
# ======== CONTINUA AQUI O SISTEMA DEPOIS DO LOGIN =========
...
# (o restante do código permanece o mesmo a partir daqui, pois já está atualizado)
